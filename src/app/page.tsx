...
import { bebasneue, dharma, inter, orbitron } from "@/lib/font";
      ...
      <section className="fixed left-0 top-0 flex size-full items-center justify-center overflow-hidden bg-gray-900">
        ...
        <div className="flex flex-col gap-10 items-center">
          <div className="pointer-events-none flex w-full flex-col items-center justify-center uppercase mix-blend-difference">
            <h1 className={cn("text-[10rem] font-bold italic leading-none sm:text-[16rem] lg:text-[24rem] text-blue-100 opacity-85", dharma.className)}>
              SANTAI
            </h1>
            <p className="-mt-2 text-lg uppercase leading-none tracking-widest opacity-50 sm:-mt-5 sm:text-xl lg:-mt-5 lg:text-2xl text-white">
              Everything Duality
            </p>
          </div>
          <HeroSearch/>
